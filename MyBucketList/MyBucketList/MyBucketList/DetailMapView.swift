    ...
    var body: some View {
        ZStack {
            ...
            .alert(isPresented: $showingPlaceDetails) {
                Alert(title: Text(selectedPlace?.title ?? "Unknown"), message: Text(selectedPlace?.subtitle ?? "Missing informations"), primaryButton: .default(Text("Ok")), secondaryButton: .default(Text("Edit")) {
