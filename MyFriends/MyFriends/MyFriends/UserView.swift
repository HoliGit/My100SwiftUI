...
struct UserView_Previews: PreviewProvider {
    static let user = User(id: "1", isActive: false, name: "Joe Blogs", age: 20, company: "Company", email: "Email", address: "Address", about: "About", registered: "", tags: [], friends: [])
